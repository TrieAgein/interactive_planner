...
@app.route('/dashboard/eventform', methods=['POST'])
#@login_required  # Assuming you have a login functionality
def eventform():
    ...
    if request.method == 'POST':
        ...
        # current_logged_in_user = User.query.filter_by(id=current_user.id).first()
